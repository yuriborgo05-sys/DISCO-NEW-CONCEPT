  ...
  if(submitted) {
      return (
         <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '2rem', flex: 1, textAlign: 'center' }}>
            ...
            <p style={{ color: 'var(--text-secondary)', marginBottom: '2rem', lineHeight: 1.5 }}>Le tue recensioni e i tuoi suggerimenti musicali sono stati inviati direttamente alla Direzione.<br/>Il tuo feedback aiuta il <strong>{config?.clubName || 'Locale'}</strong> a migliorare ogni volta.</p>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', padding: '1rem', flex: 1, paddingBottom: '2rem' }}>
       ...
       <Card style={{ marginBottom: '1.5rem', borderTop: '4px solid var(--accent-color)' }}>
          ...
          <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', marginBottom: '1.5rem' }}>Cosa vorresti vedere di più nelle prossime edizioni del <strong>{config?.clubName || 'Locale'}</strong>?</p>
